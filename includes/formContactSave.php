<!--
Identification : formContactSave.php
Author : group 14 (Nam, Yahye, Caleb, Jenny, Paul)
Purpose : Show the contact info entered and save it
-->
...
?>
	...
	<form method="POST" >
	<table>
	<tr><td>Contact Type</td><td><?php echo $_SESSION['ct_type']; ?></td></tr>
	<tr><td>Display/Business Name</td><td><?php echo $_SESSION['ct_disp_name']; ?></td></tr>
